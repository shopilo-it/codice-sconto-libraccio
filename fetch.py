#!/usr/bin/env python3
"""
Recupero codici sconto Libraccio da shopilo.it
Sursa: https://shopilo.it/negozi/libraccio.it
"""
...
SHOPILO_URL = "https://shopilo.it/negozi/libraccio.it"
STORE_NAME = "Libraccio"


def fetch_coupons(url=SHOPILO_URL):
    """Restituisce la lista dei coupon attivi per Libraccio da shopilo.it"""
    headers = {
        "User-Agent": "Mozilla/5.0 (compatible; coupon-fetcher/1.0; +https://github.com/shopilo-it/codice-sconto-libraccio)"
    }
    try:
